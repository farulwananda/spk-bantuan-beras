...
!(function (t, e) {
    ...
    var d = function (t, e) {
        ...
        h = function (t, e) {
            ...
            return (
                t.horizontal
                    ? ((a = Math.min(t.x, t.base)),
                      (n = Math.abs(t.base - t.x)))
                ...
                if (n) {
                    ...
                    t.moveTo(e, u),
                        s < d && u < c
                            ...
                            : u < c
                            ? (t.arc(s, u, l, -Math.PI, 0),
                              t.arc(s, c, l, 0, Math.PI))
    ...
    function $(t, e, r) {
        ...
        var i = r.w,
            ...
            s = e.rotation,
            u =
                Math.abs((i / 2) * Math.cos(s)) +
                Math.abs((l / 2) * Math.sin(s)),
            d =
                Math.abs((i / 2) * Math.sin(s)) +
                ...
                if (t.isObject(e))
                    if (t.isNullOrUndef(e.label))
                        if (t.isNullOrUndef(e.r))
                            for (
                                n = "", o = 0, a = (r = Object.keys(e)).length;
                                o < a;
                                ++o
                            )
                                n +=
