                ...
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('masyarakat.update', $masyarakat->id) }}" method="POST">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode" class="form-control" id="kode"
                                            placeholder="Kode" value="{{ $masyarakat->kode }}" readonly>
                                        @error('kode')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_kepala_keluarga" class="form-control"
                                            ...
                                            value="{{ old('id_kepala_keluarga', $masyarakat->id_kepala_keluarga) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kepala_keluarga" class="form-control"
                                            ...
                                            value="{{ old('kepala_keluarga', $masyarakat->kepala_keluarga) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nik" class="form-control" id="nik"
                                            placeholder="NIK" value="{{ old('nik', $masyarakat->nik) }}">
                                        @error('nik')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir"
                                            ...
                                            value="{{ old('tanggal_lahir', $masyarakat->tanggal_lahir_for_input) }}">
                                        @error('tanggal_lahir')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="provinsi" class="form-control" id="provinsi"
                                            placeholder="Provinsi" value="{{ old('provinsi', $masyarakat->provinsi) }}">
                                        @error('provinsi')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kabupaten_kota" class="form-control" id="kabupaten_kota"
                                            ...
                                            value="{{ old('kabupaten_kota', $masyarakat->kabupaten_kota) }}">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kecamatan" class="form-control" id="kecamatan"
                                            ...
                                            value="{{ old('kecamatan', $masyarakat->kecamatan) }}">
                                        @error('kecamatan')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="desa_kelurahan" class="form-control"
                                            ...
                                            value="{{ old('desa_kelurahan', $masyarakat->desa_kelurahan) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="desil_kesejahteraan" class="form-control"
                                            ...
                                            value="{{ old('desil_kesejahteraan', $masyarakat->desil_kesejahteraan) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat" class="form-control" id="alamat"
                                            placeholder="Alamat" value="{{ old('alamat', $masyarakat->alamat) }}">
                                        @error('alamat')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="padan_dukcapil" class="form-control"
                                            ...
                                            value="{{ old('padan_dukcapil', $masyarakat->padan_dukcapil) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kepemilikan_rumah" class="form-control"
                                            ...
                                            value="{{ old('kepemilikan_rumah', $masyarakat->kepemilikan_rumah) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jenis_atap" class="form-control" id="jenis_atap"
                                            ...
                                            value="{{ old('jenis_atap', $masyarakat->jenis_atap) }}">
                                        @error('jenis_atap')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jenis_dinding" class="form-control"
                                            ...
                                            value="{{ old('jenis_dinding', $masyarakat->jenis_dinding) }}">
                                        @error('jenis_dinding')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jenis_lantai" class="form-control" id="jenis_lantai"
                                            placeholder="Jenis Lantai"
                                            value="{{ old('jenis_lantai', $masyarakat->jenis_lantai) }}">
                                        @error('jenis_lantai')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sumber_penerangan" class="form-control"
                                            ...
                                            value="{{ old('sumber_penerangan', $masyarakat->sumber_penerangan) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bahan_bakar_memasak" class="form-control"
                                            ...
                                            value="{{ old('bahan_bakar_memasak', $masyarakat->bahan_bakar_memasak) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sumber_air_minum" class="form-control"
                                            ...
                                            value="{{ old('sumber_air_minum', $masyarakat->sumber_air_minum) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fasilitas_bab" class="form-control"
                                            ...
                                            value="{{ old('fasilitas_bab', $masyarakat->fasilitas_bab) }}">
                                        @error('fasilitas_bab')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <button type="submit" class="mt-4 btn btn-primary">Update Data Masyarakat</button>
                        </form>
                    </div>
                </div>
            </div>
