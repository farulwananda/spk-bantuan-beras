...
@section('content')
    <div class="container-fluid" id="container-wrapper">
        <div class="mb-4 d-sm-flex align-items-center justify-content-between">
            <h1 class="mb-0 text-gray-800 h3">Update Data Kriteria</h1>
            <ol class="breadcrumb">
            </ol>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="mb-3 card">
                    <div class="flex-row py-3 card-header d-flex align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Update Data Kriteria</h6>
                    ...
                    <div class="card-body">
                        <form action="{{ route('kriteria.update', $kriteria->id) }}" method="POST">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_kriteria" class="form-control" id="kode"
                                            placeholder="Kode" value="{{ $kriteria->kode_kriteria }}" readonly>
                                        @error('kode_kriteria')
                            ...
                            <button type="submit" class="mt-4 btn btn-primary">Update Data Kriteria</button>
                        </form>
                    </div>
                </div>
            </div>
