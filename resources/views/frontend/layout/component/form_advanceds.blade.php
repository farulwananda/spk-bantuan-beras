...
<head>
  ...
  <link href="frontend_dashboard/img/logo/logo.png" rel="icon">
  ...
  <!-- Select2 -->
  <link href="frontend_dashboard/vendor/select2/dist/css/select2.min.css" rel="stylesheet" type="text/css">
  <!-- Bootstrap DatePicker -->  
  <link href="frontend_dashboard/vendor/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet" >
  <!-- Bootstrap Touchspin -->
  <link href="frontend_dashboard/vendor/bootstrap-touchspin/css/jquery.bootstrap-touchspin.css" rel="stylesheet" >
  <!-- ClockPicker -->
  <link href="frontend_dashboard/vendor/clock-picker/clockpicker.css" rel="stylesheet">
  <!-- RuangAdmin CSS -->
...
<body id="page-top">
  ...
  <!-- Select2 -->
  <script src="frontend_dashboard/vendor/select2/dist/js/select2.min.js"></script>
  <!-- Bootstrap Datepicker -->
  <script src="frontend_dashboard/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
  <!-- Bootstrap Touchspin -->
  <script src="frontend_dashboard/vendor/bootstrap-touchspin/js/jquery.bootstrap-touchspin.js"></script>
  <!-- ClockPicker -->
  <script src="frontend_dashboard/vendor/clock-picker/clockpicker.js"></script>
