...
<head>
  ...
  <title>SPK Bantuan Pangan - Perangkingan</title>
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <div class="d-flex gap-2 justify-content-end">
                      ...
                      <button class="btn btn-success mb-1"style="margin-right: 5px;"><a href=""><i class="fa fa-file" style="color: #f3f4f7;"></i></a> Cetak</button>
                    </div>                    
