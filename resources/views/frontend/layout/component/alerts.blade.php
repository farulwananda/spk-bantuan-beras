...
<head>
  ...
  <link href="frontend_dashboard/vendor/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css">
  <link href="frontend_dashboard/css/ruang-admin.css" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="frontend_dashboard/img/logo/logo2.png">
        </div>
  ...
  <script src="frontend_dashboard/endor/jquery/jquery.min.js"></script>
